...
import { adminsIds } from "../utils/helpers";
...
const clearFilter=()=>{
  ...
  return (
    ...
    lg:px-8 border-b border-gray-300 bg-bgPrimary z-50 sticky top-0 gap-12"
    >
      {/* Logo */}
      <Link to={"/"}>
              ...
              >
                ...
                <AnimatePresence>
                  {isMenu && (
                    <motion.div
                      {...slideUpDownMenu}
                      className="absolute px-4 py-3 rounded-md bg-white right-0 top-16 flex flex-col items-center justify-start gap-3 w-64 pt-12"
                      onMouseLeave={() => {
                        setIsMenu(false);
                      }}
                    >
