...
const TemplateDesignPinDetails = () => {
  ...
  const {data:templates,refetch:temp_refetch,isLoading:tempIsLoading}=useTemplates()
  ...
  return (
    <div className='w-full flex items-center justify-center flex-col px-4 py-12'>
       ...
       <div className='w-full grid grid-cols-1 lg:grid-cols-12'>
        ...
        <div className='col-span-1 lg:col-span-8 flex flex-col items-start justify-start gap-4'>
          ...
          <div className='w-full flex flex-col items-start justify-start gap-2'>
           ...
           {user && (
            <div className='flex items-center justify-center gap-3'>
              ...
              <React.Fragment>
                <div onClick={addToCollection} className='felx items-center justify-center px-4 py-2 rounded-md border border-gray-300 gap-2 hover:bg-gray-200 cursor-pointer'>
         ...
         {data?.favourites?.includes(user?.uid)?(
              <React.Fragment>
                <div onClick={addToFavourites} className='felx items-center justify-center px-4 py-2 rounded-md border border-gray-300 gap-2 hover:bg-gray-200 cursor-pointer'>
        ...
        <div className='col-span-1 lg:col-span-4 w-full flex flex-col items-center justify-start px-3 gap-6'>
          ...
          style={{
            background:"url(https://cdn.pixabay.com/photo/2023/10/03/04/48/ai-generated-8290480_1280.jpg)",
            backgroundSize:"cover",
            backgroundPosition:"center"
          }}
          >
            <div className='absolute inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.4)]'>
              <Link to={"/"} className='px-4 py-2 rounded-md border-2 border-gray-50'>
                Discover More
              </Link>
          ...
          <div className='w-full flex items-center justify-start flex-wrap gap-2'>
            {data?.tags?.map((tag,index)=>(
              <p className='textxs border border-gray-300 px-2 py-1 rounded-md whitespace-nowrap'
              key={index}>
                {tag}
              </p>
            ))}
      ...
      {templates?.filter((temp)=>temp._id!==data?._id)?.length>0 && (
         <div className='w-full flex flex-col items-start justify-start py-8 gap-4'>
